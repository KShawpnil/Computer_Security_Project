...
-->
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-xl navbar-dark bg-dark" style="width:1520px; position:relative;">
    ...
    <div class="team-members">
      <div class="container">
        ...
        <div class="input-group" style="float: left;">
            <button name="createeventbutton" class="btn1" >Create Event</button>
