   ...
   background-color:#fff;height:7000px;">
    ...
    ?>
        ...
        <div class="input-group" style="float: left;">
            <button name="createnoticebutton" class="btn2" style="width: 200px;
	padding: 10px 10px;
	text-align: center;
	border: none;
    ...
    ?>
     ...
     <div class="shadow-1-strong bg-white my-5 p-5" id="education">
      <div class="education-section"style="position: relative;top: 30px; background-color:#fff;height:6000px;">
