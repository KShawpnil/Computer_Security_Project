...
<head>
  ...
  <title>UIUSAT - Create Event</title>
      ...
      <div class="wrapper">
        <div class="form">
          ...
          <div class="inputfield">
            ...
            <input type="date" class="input" placeholder="YYYY-MM-DD" name="eventdate">
          </div>
          <div class="inputfield">
            <label>Time Of Event:</label>
            <input type="time" class="input" name="eventtime">
          </div>
          <div class="inputfield">
            <label>Location Of Event:</label>
            <input type="text" class="input" placeholder="Maximum 200 characters" name="eventlocation">
          </div>
          ...
          <div class="inputfield">
            <label>Guests:</label>
            <input type="text" class="input" placeholder="comma-separated list; maximum 500 characters" name="eventguests">
          </div>
          <div class="inputfield">
            <label>Special Members:</label>
            <input type="text" class="input" placeholder="comma-separated list; maximum 500 characters" name="eventspecialmembers">
          </div>
          <div class="inputfield">
          ...
          <div class="inputfield">
            <label>Tag Participants:</label>
            <input type="text" class="input" placeholder="comma-separated list; student Ids only" name="participantstags">
          </div>
          <!-- <div class="inputfield">
          ...
          <div class="inputfield">
            <input type="submit" value="Create Event" class="btn" name="submit">
          </div>
        </div>
      </div>
    </form>
